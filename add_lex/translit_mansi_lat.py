...
rxCyrSoften = re.compile('([яеиёюӣ]̄?)', flags=re.I)
...
rxCyrNeutralConsSoftY = re.compile('([бвгджзкмӈпрсфхцчшщй])[\'ь]ы')
rxCyrNeutralConsSoft = re.compile('([бвгджзкмӈпрсфхцчшщй])[ь\']')
